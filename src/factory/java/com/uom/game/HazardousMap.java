...
public class HazardousMap extends Map 
{
	...
	public int generateMap() 
	{
		...
		double bluePercentage = (blueCount *100) / (size*size); //CHECKED OK
		System.out.println("blue block Percentage: " + bluePercentage);  //should be between 25 and 35%
		
		System.out.println("Hazardous Map!!!!!");
		...
		System.out.println("HazardousMap class");
		Map.printMap();
